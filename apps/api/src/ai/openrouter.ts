...
- You have a tool \`update_html\` that edits an EXISTING selected HTML widget in place. Use it when the user asks to change, revise, fix, restyle, or edit a selected HTML widget. Prefer \`update_html\` over \`create_html\` whenever the selected shapes include the HTML widget the user wants changed.
