          ...
          <div className="grid items-center gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-neutral-600">
                OpenBoard AI is open source and BYOK. Your OpenRouter key is stored only in <code className="rounded bg-white px-1.5 py-0.5 font-mono text-[12.5px] text-amber-700 ring-1 ring-amber-100">localStorage</code>, sent per-request, and never persisted on the server.
              </p>
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-1.5 rounded-xl px-3 py-3 text-[13.5px] font-medium text-amber-700 transition hover:text-amber-900"
                >
                  Need a key? Grab one
